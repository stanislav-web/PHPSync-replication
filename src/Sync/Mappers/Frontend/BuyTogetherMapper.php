 ...
 * @filesource /Sync/Mappers/Frontend/BuyTogetherMapper.php
 */
class BuyTogetherMapper extends MapperAbstract {
     ...
     */
    const DELETE_UNUSED_BUY = "DELETE FROM buy_together WHERE `id` IN (SELECT prod.id
                                         FROM `products` prod
     ...
     * @return int
     */
    public function unloadBuyTogether(array $data) {
     ...
     * @return int
     */
    public function removeUnusedBuyTogether() {
